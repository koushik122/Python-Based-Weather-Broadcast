...
timezone_lable.place(x=730,y=10)
...
# More details button
# more_button = ctk.CTkButton(root,width=100, text="For More Detail Click Here",bg_color="#47ceff",corner_radius=5, font=('Arial', 16), command= new_window)
# more_button.place(x=750, y=300)
